...
export function ImgFixedSize({ imgSrc, imgEffectSrc }: ImgFixedSizeProps) {
  ...
  return (
    <div
      ...
      className="w-40 h-40 m-4 bg-orange-300 rounded-lg shadow-md flex items-center justify-center"
    >
      {shouldRainHorseImg && <ImageRain imageSrc={imgEffectSrc} imageSize={60} />}
      <img
        src={imgSrc}
        alt="MBL"
